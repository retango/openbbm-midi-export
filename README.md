...
### Using it
You can compile it following the instruction below. Alternatively, I created a compiled version for Windows. You should first install the original BeatBuddy Manager (https://s3.amazonaws.com/mybeatbuddy/1.6.5/BeatBuddy_Manager_lite_1.6.5.exe), and set up your project and the BB Workspace. Then download "Release For Windows.zip" file from releases (of from the root of this folder) and extract into any folder in Windows, from where you can run the included BBManager-MidiExport.exe file.
